...
function weierstrassPoints(opts) {
  ...
  class Point {
    ...
    static normalizeZ(points) {
      const toInv = FpInvertBatch(Fp4, points.map((p) => p.pz));
    ...
    multiplyUnsafe(sc) {
      ...
      if (k2neg)
        k2p = k2p.negate();
      k2p = new Point(Fp4.mul(k2p.px, endo2.beta), k2p.py, k2p.pz);
      return k1p.add(k2p);
    }
    /**
...
`);
  ...
  async syncTime(canisterId) {
    await __classPrivateFieldGet4(this, _HttpAgent_instances, "m", _HttpAgent_rootKeyGuard).call(this);
    const CanisterStatus = await import("./canisterStatus-2IYE26NK.js");
...
@noble/curves/esm/ed25519.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-TR4TZVKH.js.map
