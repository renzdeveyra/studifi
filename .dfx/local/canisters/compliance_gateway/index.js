...
import { idlFactory } from './compliance_gateway.did.js';
export { idlFactory } from './compliance_gateway.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_COMPLIANCE_GATEWAY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./compliance_gateway.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the compliance_gateway canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./compliance_gateway.did.js")._SERVICE>}
 */
export const compliance_gateway = createActor(canisterId);
