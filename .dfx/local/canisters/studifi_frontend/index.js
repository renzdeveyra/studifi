...
import { idlFactory } from './studifi_frontend.did.js';
export { idlFactory } from './studifi_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_STUDIFI_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./studifi_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the studifi_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./studifi_frontend.did.js")._SERVICE>}
 */
export const studifi_frontend = createActor(canisterId);
