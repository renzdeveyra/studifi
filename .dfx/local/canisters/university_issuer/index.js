...
import { idlFactory } from './university_issuer.did.js';
export { idlFactory } from './university_issuer.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_UNIVERSITY_ISSUER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./university_issuer.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the university_issuer canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./university_issuer.did.js")._SERVICE>}
 */
export const university_issuer = createActor(canisterId);
