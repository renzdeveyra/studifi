...
import { idlFactory } from './governance_engine.did.js';
export { idlFactory } from './governance_engine.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GOVERNANCE_ENGINE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./governance_engine.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the governance_engine canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./governance_engine.did.js")._SERVICE>}
 */
export const governance_engine = createActor(canisterId);
