...
import { idlFactory } from './intelligent_credit.did.js';
export { idlFactory } from './intelligent_credit.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_INTELLIGENT_CREDIT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./intelligent_credit.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the intelligent_credit canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./intelligent_credit.did.js")._SERVICE>}
 */
export const intelligent_credit = createActor(canisterId);
