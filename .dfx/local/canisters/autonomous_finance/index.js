...
import { idlFactory } from './autonomous_finance.did.js';
export { idlFactory } from './autonomous_finance.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AUTONOMOUS_FINANCE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./autonomous_finance.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the autonomous_finance canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./autonomous_finance.did.js")._SERVICE>}
 */
export const autonomous_finance = createActor(canisterId);
