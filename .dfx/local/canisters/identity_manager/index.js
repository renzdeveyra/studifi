...
import { idlFactory } from './identity_manager.did.js';
export { idlFactory } from './identity_manager.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_IDENTITY_MANAGER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./identity_manager.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the identity_manager canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./identity_manager.did.js")._SERVICE>}
 */
export const identity_manager = createActor(canisterId);
